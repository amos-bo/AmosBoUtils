...
//    };
    ...
    public static void requesFilePermissions(Activity context, int requestCode) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(context, Manifest.permission
                    .READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {//没有权限
                ActivityCompat.requestPermissions(context, new String[]{Manifest.permission
                        .READ_EXTERNAL_STORAGE}, requestCode);
            }
        }
    }
    ...
    public static void requesLocationPermissions(Activity context, int requestCode) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(context, Manifest.permission
                    .ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {//没有权限
                ActivityCompat.requestPermissions(context, new String[]{Manifest.permission
