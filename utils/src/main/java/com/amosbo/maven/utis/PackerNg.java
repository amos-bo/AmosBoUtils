...
public final class PackerNg {
    ...
    public static synchronized MarketInfo getMarketInfo(final Object context, final String
            defaultValue) {
    ...
    public static class Helper {
        ...
        //!ZXK!
        static final byte[] MAGIC = new byte[]{0x21, 0x5a, 0x58, 0x4b, 0x21};
        // for android code
        private static String getSourceDir(final Object context)
            ...
            final Class<?> applicationInfoClass = Class.forName("android.content.pm" +
                    ".ApplicationInfo");
            ...
            if (sourceDir == null) {
                ...
                final Method getPackageCodePathMethod = contextClass.getMethod
                        ("getPackageCodePath");
        ...
        public static boolean verifyMarket(final File file, final String market) throws
                IOException {
